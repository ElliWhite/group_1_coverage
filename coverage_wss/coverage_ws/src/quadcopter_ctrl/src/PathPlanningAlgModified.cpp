...
PathPlanningAlgModified::PathPlanningAlgModified()
{
  gridWidth = 0;
  gridHeight = 0;
...
void PathPlanningAlgModified::InterpNewPoint(geometry_msgs::PoseStamped* quadPos,
...
double PathPlanningAlgModified::Distance(geometry_msgs::PoseStamped* quadPos,
                                   geometry_msgs::PoseStamped* targetPos){
...
int PathPlanningAlgModified::LoadParams(std::string controlMode,
