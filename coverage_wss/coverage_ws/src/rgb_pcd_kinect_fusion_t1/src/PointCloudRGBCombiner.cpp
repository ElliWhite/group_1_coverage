...
public:
    ...
    PointCloudRGBCombiner(ros::NodeHandle nh): nh_(nh) // ,colored_pcl_in(0L)
    {
        ...
        image_topic = getParam<std::string>(nh_, "image_topic", "/vrep/turtlebot1/rgb/image_rect_color"); 
        pcl_topic = getParam<std::string>(nh_, "pcl_topic", "/vrep/turtlebot1/depth/pcd");
        pcd_color_topic = getParam<std::string>(nh_, "pcd_color_topic", "/vrep/turtlebot1/depth/pcd_colored");
        pcd_rect_topic = getParam<std::string>(nh_, "pcd_rect_topic", "/vrep/turtlebot1/depth/pcd_rect");
